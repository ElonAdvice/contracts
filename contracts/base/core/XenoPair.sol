...
contract XenoPair is IERC20, IPair, Reentrancy {
    ...
    function mint(address to) external override lock returns (uint liquidity) {
        ...
        require(liquidity > 0, "XenoPair: INSUFFICIENT_LIQUIDITY_MINTED");
        _mint(to, liquidity);
    ...
    function burn(
        ...
        require(
            amount0 > 0 && amount1 > 0,
            "XenoPair: INSUFFICIENT_LIQUIDITY_BURNED"
        );
    ...
    function swap(
        ...
        require(!IFactory(factory).isPaused(), "XenoPair: PAUSE");
        require(
            amount0Out > 0 || amount1Out > 0,
            "XenoPair: INSUFFICIENT_OUTPUT_AMOUNT"
        );
        (uint _reserve0, uint _reserve1) = (reserve0, reserve1);
        require(
            amount0Out < _reserve0 && amount1Out < _reserve1,
            "XenoPair: INSUFFICIENT_LIQUIDITY"
        );
        uint _balance0;
        uint _balance1;
        {
            ...
            (address _token0, address _token1) = (token0, token1);
            require(to != _token0 && to != _token1, "XenoPair: INVALID_TO");
        ...
        require(
            ...
            "XenoPair: INSUFFICIENT_INPUT_AMOUNT"
        );
        {
    ...
    function approve(
        ...
        require(spender != address(0), "XenoPair: Approve to the zero address");
    ...
    function permit(
        ...
        require(deadline >= block.timestamp, "XenoPair: EXPIRED");
    ...
    function transferFrom(
        ...
        if (spender != src && spenderAllowance != type(uint).max) {
            require(
                ...
                "XenoPair: Insufficient allowance"
            );
            unchecked {
    ...
    function _transferTokens(address src, address dst, uint amount) internal {
        require(dst != address(0), "XenoPair: Transfer to the zero address");
        ...
        require(
            srcBalance >= amount,
            "XenoPair: Transfer amount exceeds balance"
        );
        unchecked {
