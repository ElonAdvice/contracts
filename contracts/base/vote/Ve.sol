...
contract Ve is IERC721, IERC721Metadata, IVe, Reentrancy {
    ...
    string public constant override name = "veXENO";
    string public constant override symbol = "veXENO";
    ...
    function _tokenURI(
        ...
        uint untilEnd = (block.timestamp < _lockedEnd)
            ? _lockedEnd - block.timestamp
            : 0;
